...
namespace A2GurtejSingh {
    ...
    public partial class NorthwindDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeesRow AddEmployeesRow(string LastName, string FirstName, string Title, string BirthDate) {
        ...
        public partial class Employees1DataTable : global::System.Data.TypedTableBase<Employees1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public Employees1Row AddEmployees1Row(string LastName, string FirstName, string Title, int Age, string BirthDate) {
        ...
        public partial class OrdersDataTable : global::System.Data.TypedTableBase<OrdersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public OrdersRow AddOrdersRow(string EmployeeName, string ShipCity, string ShipCountry, string OrderDate, string ShippedDate) {
        ...
        public partial class Employees1Row : global::System.Data.DataRow {
            ...
            public int Age {
                get {
                    try {
                        return ((int)(this[this.tableEmployees1.AgeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Age\' in table \'Employees1\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableEmployees1.AgeColumn] = value;
                }
            }
            ...
            public string BirthDate {
                get {
                    try {
                        return ((string)(this[this.tableEmployees1.BirthDateColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public bool IsAgeNull() {
                return this.IsNull(this.tableEmployees1.AgeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetAgeNull() {
                this[this.tableEmployees1.AgeColumn] = global::System.Convert.DBNull;
            }
...
namespace A2GurtejSingh.NorthwindDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, LastName, FirstName, Title, CONVERT(VARCHAR(10), BirthDate, 10" +
                "1) AS BirthDate\r\nFROM   Employees";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT EmployeeID, FirstName, LastName, Title, CONVERT(VARCHAR(10), BirthDate, 10" +
                "1) AS BirthDate\r\nFROM   Employees\r\nWHERE (FirstName + LastName LIKE \'%\' + @Emplo" +
                "yeeName + \'%\')";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@EmployeeName", global::System.Data.SqlDbType.NVarChar, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual NorthwindDataSet.EmployeesDataTable GetEmployees() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        public virtual int FillByName(NorthwindDataSet.EmployeesDataTable dataTable, string EmployeeName) {
        ...
        public virtual NorthwindDataSet.EmployeesDataTable SearchByName(string EmployeeName) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((EmployeeName == null)) {
                throw new global::System.ArgumentNullException("EmployeeName");
            }
    ...
    public partial class Employees1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Employees] WHERE (([EmployeeID] = @Original_EmployeeID) AND ([LastNa" +
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Employees] ([LastName], [FirstName], [Title]) VALUES (@LastName, @FirstName, @Title);
SELECT EmployeeID, LastName, FirstName, Title, CONVERT (VARCHAR(10), BirthDate, 101) AS BirthDate, DATEDIFF(YY, BirthDate, GETDATE()) AS Age FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY()) ORDER BY Age";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Employees] SET [LastName] = @LastName, [FirstName] = @FirstName, [Title] = @Title WHERE (([EmployeeID] = @Original_EmployeeID) AND ([LastName] = @Original_LastName) AND ([FirstName] = @Original_FirstName) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)));
SELECT EmployeeID, LastName, FirstName, Title, CONVERT (VARCHAR(10), BirthDate, 101) AS BirthDate, DATEDIFF(YY, BirthDate, GETDATE()) AS Age FROM Employees WHERE (EmployeeID = @EmployeeID) ORDER BY Age";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT EmployeeID, LastName, FirstName, Title, CONVERT(VARCHAR(10), BirthDate, 10" +
                "1) AS BirthDate, DATEDIFF(YY, BirthDate, GETDATE()) AS Age\r\nFROM   Employees\r\nOR" +
                "DER BY Age";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int FillByAge(NorthwindDataSet.Employees1DataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual NorthwindDataSet.Employees1DataTable GetEmpAge() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            NorthwindDataSet.Employees1DataTable dataTable = new NorthwindDataSet.Employees1DataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(NorthwindDataSet.Employees1DataTable dataTable) {
    ...
    public partial class OrdersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT TOP (750) Orders.OrderID, Employees.FirstName + ' ' + Employees.LastName AS EmployeeName, CONVERT(VARCHAR(10), Orders.OrderDate, 101) AS OrderDate, CONVERT(VARCHAR(10), Orders.ShippedDate, 101) AS ShippedDate, Orders.ShipCity, Orders.ShipCountry
FROM   Employees INNER JOIN
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int FillByOrderDetails(NorthwindDataSet.OrdersDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual NorthwindDataSet.OrdersDataTable GetShipmentInfo() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
